                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a href="<?= site_url('admin/pindah/addoutlet') ?>">
                        ...
                        <div class="table-responsive table--no-card m-b-30" style="margin-top: 10px;">
                            <table class="table table-borderless table-striped" style="background-color: #4272d7;">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no = 1;
                                                foreach ($getoutlet as $get) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $get->id_outlet ?></td>
                                                        <td><?php echo $get->nama ?></td>
                                                        <td><?php echo $get->alamat ?></td>
                                                        <td><?php echo $get->tlp ?></td>
                                                        <td>
                                                            <a href="<?= site_url('admin/pindah/editoutlet/'.$get->id_outlet) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                            <a href="<?= site_url('admin/crud/hapus_outlet/'.$get->id_outlet) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                }
