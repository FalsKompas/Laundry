    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #4272d7;"><i style="color: white;">Edit Outlet</i></div>
                    <div class="card-body card-block">
                        <?php 
                            foreach ($getdata as $id) { ?>
                        <form action="<?php echo base_url() ?>index.php/admin/crud/update" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-key"></i>
                                    </div>
                                        <input type="text" id="id_outlet" name="id_outlet" value="<?php echo $id->id_outlet; ?>" class="form-control" readonly>
                                </div>
                            </div>
                            <!-- <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" id="nama" name="nama" value="<?php echo $id->nama ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="alamat" name="alamat" value="<?php echo $id->alamat ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="notlp" class="form-control" value="<?php echo $id->tlp ?>" id="notlp">
                                </div>
                            </div>
