            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url() ?>index.php/admin/crud/add" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="alamat" name="alamat" placeholder="Alamat Toko" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="notlp" class="form-control" placeholder="No Telepon" id="notlp">
                                </div>
                            </div>
