    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #4272d7;"><i style="color: white;">Add Produk/Paket Cucian</i></div>
                    <div class="card-body card-block">
                        <form action="<?php echo base_url() ?>index.php/admin/crud/addproduk" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-key"></i>
                                    </div>
                                        <input type="text" id="id_paket" name="id_paket" value="<?php echo $getid; ?>" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="id_outlet" value="<?php echo $data->id_outlet ?>">
                                        <option><---Pilih---></option>
                                        <?php 
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="namapaket" class="form-control" placeholder="Nama Paket" id="namapaket">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="harga" class="form-control" placeholder="Harga Paket" id="harga">
                                </div>
                            </div>
