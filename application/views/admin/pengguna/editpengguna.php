    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #4272d7;"><i style="color: white;">Edit Pengguna</i></div>
                    <div class="card-body card-block">
                        <?php 
                            foreach ($databyid as $data) { ?>
                        <form action="<?php echo base_url() ?>index.php/admin/crud/editpengguna" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-key"></i>
                                    </div>
                                        <input type="text" id="id_user" name="id_user" value="<?php echo $data->id_user; ?>" class="form-control" readonly>
                                </div>
                            </div><!-- 
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="file" id="gambar" name="gambar" class="form-control" value="<?php echo $data->gambar ?>">
                                </div>
                            </div> -->
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="id_outlet" class="form-control" value="<?php echo $data->id_outlet ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="role" class="form-control" value="<?php echo $data->role ?>" readonly>
                                </div>
                            </div>
