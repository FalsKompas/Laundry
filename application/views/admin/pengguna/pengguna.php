                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a href="<?= site_url('admin/pindah/addpengguna') ?>">
                            ...
                            <table class="table table-borderless table-striped" style="background-color: #4272d7;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $get->gambar ?>" width="100"></td>
                                        <td><?php echo $get->nama ?></td>
                                        <td><?php echo $get->id_outlet ?></td>
                                        <td><?php echo $get->role ?></td>
                                        <td>
                                            <a href="<?= site_url('admin/pindah/edituser/'.$get->id_user) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                            <a href="<?= site_url('admin/crud/hapus_user/'.$get->id_user) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
