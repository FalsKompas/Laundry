            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <?php 
                            foreach ($data as $d) { ?>
                        <form action="<?php echo base_url() ?>index.php/admin/crud/editmember" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-key"></i>
                                    </div>
                                        <input type="text" id="id_member" name="id_member" value="<?php echo $d->id_member; ?>" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tlp" class="form-control" value="<?php echo $d->tlp; ?>" id="tlp">
                                </div>
                            </div>
