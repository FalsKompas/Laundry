                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a href="<?= site_url('admin/pindah/addmember') ?>">
                            ...
                            <table class="table table-borderless table-striped" style="background-color: #4272d7;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('admin/pindah/editmember/'.$get->id_member) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                            <a href="<?= site_url('admin/crud/hapus_member/'.$get->id_member) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
