    ...
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #4272d7;"><i style="color: white;">Add Member</i></div>
                    <div class="card-body card-block">
                        <form action="<?php echo base_url() ?>index.php/admin/crud/addmember" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-key"></i>
                                    </div>
                                        <input type="text" id="id_member" name="id_member" value="<?php echo $getid; ?>" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nama" name="nama" placeholder="Nama Member" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tlp" class="form-control" placeholder="No Telepon" id="tlp">
                                </div>
                            </div>
