...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <a href="<?= site_url('C_login/logout'); ?>">Sign out</a>
        ...
        <div class="page-container2">
            ...
            <!-- STATISTIC-->
            <div class="row m-t-25" style="padding: 10px;">
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                <i class="zmdi zmdi-account"><?php echo $getrow_m ?></i>
                                            </div>
                                            <div class="text">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                <i class="fa fa-shopping-basket"><?php echo $getrow_p ?></i>
                                            </div>
                                            <div class="text">
                                                <span>Jumlah Produk Cucian</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                <i class="zmdi zmdi-shopping-cart">10</i>
                                            </div>
                                            <div class="text">
                            ...
                            <div class="col-sm-6 col-lg-3" style="margin-left: 270px;">
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                <i class="zmdi zmdi-account"><?php echo $getrow_u ?></i>
                                            </div>
                                            <div class="text">
