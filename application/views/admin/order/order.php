...
<body class="animsition">
            ...
            <form action="<?php echo base_url() ?>index.php/admin/crud/addorder" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">Pilih Paket</i>
                                <div class="input-group">
                                    <select onchange="auto()" id="id_paket" name="paket" class="col-md-8" class="form-control" value="<?php echo $get->id_paket ?>">
                                        <option> <---   Pilih Paket   ---></option>
                                        <?php 
                                            foreach ($getproduk as $get) { ?>
                                                <option value="<?php echo $get->id_paket ?>"><?php echo $get->nama_paket ?></option>
                                        <?php
                                            }
                                         ?>
                                    </select>
                                    <input type="number" id="qty" name="qty" class="form-control" style="margin-left: 10px;, width: 20px;">
                                </div>
                            </div>
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">Outlet</i>
                                <div class="input-group">
                                    <select class="form-control" name="outlet" value="<?php echo $outlet->id_outlet ?>">
                                        <option><---  Outlet  ---></option>
                                        <?php 
                                            foreach ($getoutlet as $outlet) { ?>
                                                <option value="<?php echo $outlet->id_outlet ?>"><?php echo $outlet->nama ?></option>
                                        <?php
                                            }
                                         ?>
                                    </select>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #4272d7;"><i style="color: white;, font-style: unset;">Member</i></div>
                    <div class="card-body card-block">
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;, font-size: 20;">Id Member</i>
                                <div class="input-group">
                                    <input type="text" id="id_member" name="id_member" placeholder="Id member..." class="form-control" onkeyup="isi_otomatis()">
                                </div>
                            </div>
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">Nama Member</i>
                                <div class="input-group">
                                    <input type="text" name="nama" class="form-control" id="nama" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">Alamat</i>
                                <div class="input-group">
                                    <input type="text" name="alamat" class="form-control" id="alamat" readonly="">                                    
                                </div>
                            </div>
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">Jenis Kelamin</i>
                                <div class="input-group">
                                    <input type="text" name="jk" class="form-control" id="jk" readonly="">                                    
                                </div>
                            </div>
                            <div class="form-group">
                                <i style="font-family: serif; font-style: unset;">No Telepon</i>
                                <div class="input-group">
                                    <input type="text" name="notlp" class="form-control" id="notlp" readonly="">                                    
                                </div>
                            </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            <i style="font-family: serif; font-style: unset;">Tanggal Pengambilan</i>
                            <div class="input-group">
                                <input type="date" name="batas" class="form-control" id="batas">
                            </div>
                        </div>
                        <div class="form-group">
                            <i style="font-family: serif; font-style: unset;">Kasir</i>
                            <div class="input-group">
                                <input type="text" name="id_user" class="form-control" id="id_user" value="<?php echo $this->session->userdata('id_user'); ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <i style="font-family: serif; font-style: unset;">Diskon Member</i>
                            <div class="input-group">
    ...
    <script type="text/javascript">
        function isi_otomatis(){
            ...
            $.ajax({
                url: '<?= site_url('admin/pindah/getdata') ?>',
